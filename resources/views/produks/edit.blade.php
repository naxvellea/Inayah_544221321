    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" style="background-color:#3081D0;"href="{{ route('produks.index') }}"> Back</a>
            </div>
        </div>
    </div>
        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
              <button type="submit" class="btn btn-primary"style="background-color:#3081D0;">Submit</button>
            </div>
        </div>
