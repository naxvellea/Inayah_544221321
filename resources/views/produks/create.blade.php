...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn"style="background-color:#756AB6;" href="{{ route('produks.index') }}"> Back</a>
        </div>
    </div>
</div>
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" name="harga_beli" placeholder="harga"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn"style="background-color:#756AB6;">Submit</button>
        </div>
    </div>
